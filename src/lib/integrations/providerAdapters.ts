...
const providerDefinitions: ProviderDefinition[] = [
  ...
  { key: ProviderKey.VerizonConnect, name: "Verizon Connect", category: "fleet", icon: "location-crosshairs", description: "Fleet tracking and workforce management", capabilities: { canConnect: true, canDisconnect: true, hasSync: false } },
  { key: ProviderKey.Geotab, name: "Geotab", category: "fleet", icon: "map-pin", description: "Telematics and fleet optimization platform", capabilities: { canConnect: true, canDisconnect: true, hasSync: false } },
  { key: ProviderKey.Fleetio, name: "Fleetio", category: "fleet", icon: "truck", description: "Fleet maintenance and fuel management", capabilities: { canConnect: true, canDisconnect: true, hasSync: false } },
  ...
  { key: ProviderKey.WEX, name: "WEX", category: "fuel", icon: "gas-pump", description: "Fleet fuel cards and spend management", capabilities: { canConnect: true, canDisconnect: true, hasSync: false } },
