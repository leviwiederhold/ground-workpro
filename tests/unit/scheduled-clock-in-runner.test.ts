...
// surface the runner uses (eq/is/not/gte/in/order/limit/select/update/insert)
// to exercise the real write + audit paths, including the guarded update that
// is what actually prevents duplicate clock-ins.
// ---------------------------------------------------------------------------
...
function eventTypes(db: ReturnType<typeof makeDb>): string[] {
